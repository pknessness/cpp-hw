...
void ChassisTankDriveCommand::execute()
{
    chassis->setDesiredOutput(
        controlOperatorInterfaceEdu.getChassisLeftInput() * ChassisSubsystem::MAX_CURRENT_OUTPUT, 
        controlOperatorInterfaceEdu.getChassisRightInput() * ChassisSubsystem::MAX_CURRENT_OUTPUT);
}
